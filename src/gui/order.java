...
kontrol_menu k;
kontrol_order ko;
String iddetailorder,idorder,nomeja,tanggal,iduser,qty,status,idmenu;
...
private void tampildata() {
 ...
 private void settabel() {
     ...
     lblidmenu.setText(tabel.getValueAt(tabel.getSelectedRow(), 0).toString());
     ...
     if (txtidorder.getText().isEmpty() || 
         ...
         try {
             ...
             if (rs.next()) {
                 ...
                 ko.simpandataorder(idorder, nomeja, tanggal, iduser, qty, status);         
             }
         } catch (SQLException ex) {
             Logger.getLogger(order.class.getName()).log(Level.SEVERE, null, ex);
         }
        ko.simpandatadetailorder(idorder, idmenu, qty, status);
...
//             d.lbljumlah.setText(txtqty.getText());
//             if (dtp.isSelected()) {
