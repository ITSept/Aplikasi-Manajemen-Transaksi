...
public class level extends javax.swing.JDialog {
    ...
    public void no() {
        DefaultTableModel dtm = (DefaultTableModel) tblevel.getModel();
        int jumlah = dtm.getRowCount();
        for (int i = 0; i < jumlah; i++);
            int nomor;
            nomor = jumlah + 1;
            txtidlevel.setText(Integer.toString(nomor));   
    }
    ...
    private void initComponents() {
        ...
        tblevel.setBackground(new java.awt.Color(204, 204, 204));
        ...
        tblevel.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tblevelMouseClicked(evt);
            }
        });
    ...
    private void tblevelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblevelMouseClicked
        ...
        simpan.setEnabled(false);
        canceledit.setVisible(false);
    }//GEN-LAST:event_tblevelMouseClicked
...
private void tampildata () {
    ...
    dtm.setRowCount(0);
    e.tampildata(dtm);
    tblevel.setModel(dtm);
}

private void setformtable() {
     txtidlevel.setText(tblevel.getValueAt(tblevel.getSelectedRow(), 0).toString());
     txtnamalevel.setText(tblevel.getValueAt(tblevel.getSelectedRow(), 1).toString());
